...
We draw the EGIDS scale from the supplementary data of Bromham et al (2022).
...
| 6b        | Threatened     | "The language is used orally by all generations but only some of the                                                         
                              child-bearing generation are transmitting it to their children."                                                              | Vulnerable            |
| 7         | Shifting       | "The child-bearing generation knows the language well enough to use                                                          
                              it among themselves but none are transmitting it to their children."                                                          | Definitely Endangered |
...
languages = left_join(languages, kiddgarcia, 
...
## Add glottocodes to the languages data
# languages = left_join(languages, glottolog_languages[,c("ISO639P3code", "Glottocode")],
#                       by = c("LANG_ISO" = "ISO639P3code"))
