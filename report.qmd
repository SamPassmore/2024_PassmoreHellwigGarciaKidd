...
PHOIBLE is a repository of cross-linguistic phonological inventory data, which have been extracted from source documents and tertiary databases and compiled into a single searchable convenience sample. For a detailed description of Phoible, see [Moran (2012)](https://digital.lib.washington.edu/researchworks/handle/1773/22452). The data can be explored at the website: https://phoible.org/
...
pp = 
  ...
  theme_classic(base_size = font_size) + 
  xlab("Years") +
  ylab("N of new languages studied / \n N of Papers published per year") + 
